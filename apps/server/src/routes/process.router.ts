...
import { addProcess, updateProcess, completeProcess, cancelProcess, interruptProcess } from '../controllers/process';
...
router.delete('/:id', processValidation.completeProcess, authMiddleware, deviceMiddleware, completeProcess);
