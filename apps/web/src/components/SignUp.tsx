    ...
    <div>
      <Stack horizontalAlign="center">
        <div style={{ width: '250px' }}>
          {querying ? <Label>Идет запрос к серверу...</Label> : null}
          {errorMessage && <Label>{`Ошибка при регистрации пользователя на сервере: ${errorMessage}`}</Label>}
          <TextField
            label="User name:"
            value={userName}
          ...
          <TextField
            ...
            onChange={(_, repeatPassword) =>
              repeatPassword !== undefined ? setRepeatPassword(repeatPassword) : undefined
            }
          />
          <PrimaryButton
            text="Signup"
