      ...
      {infoWindow === 1 ? (
        <AppScreen>
          <Text style={styles.textInfo}>
            {
              'Добро пожаловать в GDMN Отгрузка!\n\nНаше приложение облегчает процесс перемещения готовой продукции и позволяет выполнить следующие действия: \n\n1. Оформить внутреннее перемещение товаров между складскими подразделениями и экспедициями по одним или несколькими документами\n\n2. Создать отвес-накладную по готовым заявкам либо без заявки. При наличии заявки осуществляется котроль соответствия отвеса заявленному количеству.'
            }
          </Text>
          <TouchableOpacity
