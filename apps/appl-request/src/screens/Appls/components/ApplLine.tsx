...
import { IGood, IApplLine, IPackageGood } from '../../../store/docs/types';
...
interface IProps {
  item: IApplLine;
  onSetLine: (value: IApplLine) => void;
}

type Icon = keyof typeof MaterialCommunityIcons.glyphMap;

const ApplLine = ({ item, onSetLine }: IProps) => {
  const navigation = useNavigation();
  const dispatch = useDispatch();

  const { docId, mode } = useRoute<RouteProp<ApplsStackParamList, 'ApplLine'>>().params;
