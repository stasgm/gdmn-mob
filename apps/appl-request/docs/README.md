...
<img src="img/1.Manual/1.1.StartScreen.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.1.Connection.jpg" alt="drawing" width="300"/>

В правом нижнем углу находится иконка, по нажатию на которую можно попасть на экран **Настройка подключения**.

<img src="img/1.Manual/1.1.ConnectionSettings.jpg" alt="drawing" width="300"/>
...
Вернемся в предыдущий экран и нажмем кнопку **Подключиться** (при повторном запуске в рабочей версии программы будет происходить автоподключение).

Если подключение прошло успешно, то появляется экран для ввода кода активации (при повторном запуске в будет происходить автоматический вход в учетную запись пользователя). Здесь нужно ввести код, ранее полученный в web-admin. По нажатию на иконку в правом нижнем углу можно перейти в предыдущий экран.

<img src="img/1.Manual/1.1.Activation.jpg" alt="drawing" width="300"/> <img src="img/1.Manual/1.1.Code.jpg" alt="drawing" width="300"/>

Если код активирован, появляется экран для входа пользователя. В соответствующие поля необходимо ввести **Имя пользователя** и **Пароль** и нажать на кнопку **Войти**. По нажатию на иконку в правом нижнем углу можно перейти в предыдущий экран.

<img src="img/1.Manual/1.1.Login.jpg" alt="drawing" width="300"/> <img src="img/1.Manual/1.1.LoginUser.jpg" alt="drawing" width="300"/>

После входа в приложение попадаем в экран **Заявки**.

<img src="img/1.Manual/1.1.Requests.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.1.Sidebar.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.2.RequestsActive.jpg" alt="drawing" width="300"/> <img src="img/1.Manual/1.2.RequestsArchive.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.2.RequestViewOne.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.2.RequestsOne.jpg" alt="drawing" width="300"/>

Зайдем в другую заявку и отклоним ее. При отказе необходимо внести причину отказа в появившемся окне.

<img src="img/1.Manual/1.2.RequestViewTwo.jpg" alt="drawing" width="300"/> <img src="img/1.Manual/1.2.Otkaz.jpg" alt="drawing" width="300"/>

Вернемся в экран просмотра всех заявок. У двух заявок цвет полосы зеленый, они в состоянии **Обработано**.

<img src="img/1.Manual/1.2.RequestsReady.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.2.RequestsSent.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.3.References.jpg" alt="drawing" width="300"/>

При нажатии на конкретный справочник переходим на экран просмотра.

<img src="img/1.Manual/1.3.ReferenceUsers.jpg" alt="drawing" width="300"/>
...
<img src="img/1.Manual/1.3.UsersPosition.jpg" alt="drawing" width="300"/>

Рассмотрим еще один справочник.

<img src="img/1.Manual/1.3.ReferencesRequests.jpg" alt="drawing" width="300"/> <img src="img/1.Manual/1.3.RequestsPosition.jpg" alt="drawing" width="300"/>
