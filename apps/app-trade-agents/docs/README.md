...
После добавления заявки откроется экран с информацией об объекте. Нажав на блок с информацией можно изменить дата отгрузки заявки.
