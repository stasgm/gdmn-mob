...
export interface OrderListItemProps {
  children?: ReactNode;
  onPress: (name: 'edit' | 'delete') => void;
}

const SwipeLineItem = ({ children, onPress }: OrderListItemProps) => {
  ...
  const renderRightAction = (name: 'edit' | 'delete', icon: any, color: any, x: any, progress: any) => {
