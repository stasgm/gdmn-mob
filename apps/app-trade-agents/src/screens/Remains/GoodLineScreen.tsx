    ...
    <AppScreen>
      <ScrollView>
        <View>
          ...
          <View style={styles.item}>
            <View style={styles.details}>
              <Text style={styles.name}>Цена ФСН</Text>
              <Text style={textStyle}>{item?.priceFsn || '0'} р</Text>
            </View>
          </View>
          <ItemSeparator />
          ...
          <View style={styles.item}>
            <View style={styles.details}>
              <Text style={styles.name}>Цена ФСО</Text>
              <Text style={textStyle}>{item?.priceFso || '0'} р</Text>
            </View>
          </View>
          <ItemSeparator />
          ...
          <View style={styles.item}>
            <View style={styles.details}>
              <Text style={styles.name}>Цена ФСН (склад)</Text>
              <Text style={textStyle}>{item?.priceFsnSklad || '0'} р</Text>
            </View>
          </View>
          <ItemSeparator />
          ...
          <View style={styles.item}>
            <View style={styles.details}>
              <Text style={styles.name}>Цена ФСО (склад)</Text>
              <Text style={textStyle}>{item?.priceFsoSklad || '0'} р</Text>
            </View>
          </View>
        </View>
      </ScrollView>
