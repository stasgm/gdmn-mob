...
import { getLineUnitName } from '../../../utils/helpers';
...
const OrderItem = ({
  ...
  const unitName = getLineUnitName(item.good.invWeight || 1, item.good.valueName, isUseUnitMeasure, isUseRemains);
      ...
      <View style={styles.item}>
        ...
        <View style={styles.details}>
          ...
          <View style={styles.directionRow}>
            <MediumText>
              {item.quantity} {unitName} / {(item.good.priceFsn || 0).toString()} р.
            </MediumText>
          </View>
