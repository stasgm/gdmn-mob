...
const setScreenFormParams = createAction('APP/SET_SCREEN_FORM_PARAMS')<ISetScreenFormParam>();
...
const addError = createAction('APP/ADD_ERROR_ONE')<IDeviceLogEntry>();
...
const removeSyncRequest = createAction('APP/DEL_SYNC_REQUEST')<CmdNameSyncRequest>();
