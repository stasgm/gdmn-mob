...
export const MainContainer = (props: AppViewProps) => (
  <Centered style={[BaseStyle.mainContainer, props.style]} accessibilityRole="main" {...props} />
);
...
export const Box = (props: AppViewProps & { noBorder?: boolean }) => (
  <Centered style={[BaseStyle.box, props.noBorder && { borderTopWidth: 0 }, props.style]} fullWidth {...props} />
);

export const Grid = (props: AppViewProps) => <AppView style={[BaseStyle.grid, props.style]} {...props} />;

export const GridItem = (props: AppViewProps) => <Centered style={[BaseStyle.gridItem, props.style]} {...props} />;

export const BorderBox = (props: AppViewProps) => <Centered style={[BaseStyle.borderBox, props.style]} {...props} />;
