...
| Параметр | Описание |
| ------------ | -------- |
|Синхронизация   | Автоматическая синхронизация не может быть меньше периода синхронизации на сервере  |
...
Чтобы загрузить данные, предназначенные для пользователя, сперва, в Настройках необходимо  указать параметр **Запрашивать таблицы**, а далее следует нажать на кнопку  <img src="img/1.Connection/1.Sync.jpg" alt="drawing" height="27"/> **Синхронизировать** в нижней части бокового меню.
...
<img src="img/3.Orders/3.OrderViewGoods1.jpg" alt="drawing" height="400"/>
...
!!!!После получения ответа обработки, цвет станет синим!!!
