...
После отправки документ перейдет в статус **Отправлен** <img src="img/1.Connection/1.IconSent.JPG" alt="drawing" height="22"/> (желтый цвет) - редактирование и удаление невозможно.
