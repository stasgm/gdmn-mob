...
Перейдем на экран **Точки маршрутов**.
...
При первом сеансе программа запросит разрешение на доступ к данным о месте расположения мобильного устройства, но в дальнейшем это будет проходить автоматически.

 !!!!!(в этот момент один раз телефон попросит разрешение на получение геокоординаты, которая будет записана в визит данной точки).?????
