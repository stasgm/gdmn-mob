...
<img src="img/1.Connection/1.NewSyncDate.jpg" alt="drawing" height="400"/> <img src="img/1.Connection/1.MorningUpdate.jpg" alt="drawing" height="400"/>
...
После ввода всех заявок и отправления их на сервер далее следует проверить получен ли ответ от сервера: успешно ли созданы заявки в Гедымине или отклонены по разным причинам. 
