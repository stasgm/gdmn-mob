...
По нажатию на кнопку меню, расположенную в правом верхнем углу отобразится выпадающее меню со следующими пунктами: **Добавить товар**, **Редактировать данные**, **Удалить заявку**.

<img src="img/3.Orders/3.ViewMenu.jpg" alt="drawing" height="400"/>

Либо выбрав пункт **Добавить товар**, либо нажав на иконку **+** переходим на экран выбора группы и товара новой позиции документа:
...
<img src="img/3.Orders/3.OrderViewGoods.jpg" alt="drawing" height="400"/> <img src="img/3.Orders/3.GoodSwipe.jpg" alt="drawing" height="400"/>
...
<img src="img/3.Orders/3.DocsSentSync.jpg" alt="drawing" height="400"/> <img src="img/3.Orders/3.DocsSent.jpg" alt="drawing" height="400"/>
