...
<img src="img/5.Routes/5.AllOrders.jpg" alt="drawing" height="400"/>
 ...
 Предыдущие можно просматривать и копировать в текущий визит.
  ...
  Для этого нужно выбрать заявку из данного списка, открыть её и выбрать пункт из меню " **≡** " *"Копировать заявку"*. После чего произойдет переход на новую скопированную заявку.
