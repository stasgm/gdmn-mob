...
- можно, через меню " **⁝** " в правом верхнем углу, выбрав пункт **Добавить товар**.

<img src="img/3.Orders/3.ViewMenu.jpg" alt="drawing" height="400"/>

- можно добавить новую позицию в документ **заявки** нажатием на иконку **✚**, после чего переходим на экран **Выбор товара**:
