...
<img src="img/8.Settings/8.Settings.jpg" alt="drawing" height="400"/>  <img src="img/8.Settings/8.SettingsBack.jpg" alt="drawing" height="400"/> 
...
Чтобы загрузить данные, предназначенные для пользователя, следует нажать на кнопу **Синхронизировать** в нижней части бокового меню.
...
Чтобы найти справочник по наименованию можно воспользоваться строкой поиска, нажав на иконку <img src="img/1.Connection/1.IconSearch.jpg" alt="drawing" height="22"/>  **Поиск** в правом верхнем углу экрана.
 ...
 **Упаковка** заполняется только при наличии предложенных вариантов.
 ...
 После выбора товара и заполнения формы **Количество**, **Упаковка**, выбранный товар будет отображаться в списках товаров.

Так выглядят списки **Товарные группы** и **Справочник ТМЦ**.
...
Ежедневно, в начале работы с приложением, необходимо делать синхронизацию для получения  справочников с актуальными даннными, матриц, дебеторских задолженностей и новых маршрутов. 
...
При выборе (нажатием на строку) необходимого маршрута откроется экран с торговыми точками, запланированными для посещения, то есть переходим на экран **Точки маршрутов**.
...
При первом сеансе программа запросит разрешение на доступ к данным о месте расположения мобильного устройства, если ответ будет *"Всегда разрешать"*, то в дальнейшем это будет проходить автоматически. 
...
Из экрана визита пользователь имеет возможность:
- создать заявку
- посмотреть текущие и предыдущие заявки, сделанные ранее
- удалить заявки со статусом **Черновик** и **Готов к отправке**
- отправить все заявки на сервер с помощью кнопки <img src="img/1.Connection/1.IconSend.jpg" alt="drawing" height="22"/> **Отправка документа**

 Для создания заявки нажимаем на кнопку " **✚** " **Добавить документ**.

После добавления заявки откроется экран заявки.
