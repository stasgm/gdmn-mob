...
<img src="img/8.Settings/8.Settings.jpg" alt="drawing" height="400"/>   <img src="img/8.Settings/8.SettingsMenu.jpg" alt="drawing" height="400"/>
...
|Использовать остатки| _Если указан_, то при добавлении товара будет учитываться его наличие в остатках. Также будет доступен пункт меню **Остатки**.|

Синхронизация:

<img src="img/8.Settings/8.Synchr.jpg" alt="drawing" height="400"/>
...
|Автосинхронизации, мин|Параметр, указывающий, через какой период будет выполняться автосинхронизация при включенном параметре "Автоматическая синхронизация". По протяжённости периода параметр должен быть больше периода синхронизации на сервере.|
...
Количество дней хранения всех типов документов в приложении, отсчитываемое от даты создания документа.
