...
- отправить ВСЕ заявки со статусом **Готов к отправке** на сервер с помощью кнопки <img src="img/1.Connection/1.IconSend.jpg" alt="drawing" height="22"/> **Отправка документа**
