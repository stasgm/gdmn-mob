...
Чтобы добавить новую позицию в документ заявки нажимаем на иконку **✚** и переходим на экран **Выбор товара**:

<img src="img/3.Orders/3.GroupOne.jpg" alt="drawing" height="400"/>

Окно для выбора групп и товара выглядит так - группы отображаются в виде блоков:
...
Добавить позицию, также можно, через меню " **⁝** " в правом верхнем углу, выбрав пункт **Добавить товар**.
...
<img src="img/3.Orders/3.GoodsWithoutCont.jpg" alt="drawing" height="400"/>  <img src="img/3.Orders/3.GoodsWithCont.jpg" alt="drawing" height="400"/>
 ...
 После выбора товара и заполнения форм **Количество** и **Упаковка**, выбранный товар будет отображаться в списках товаров серым цветом с указанием количества и вида упаковки, а иконка товара поменяет цвет с красного на синий.
...
Обработка нажатия элемента товара сделана так:
Если щелкнуть по товару, который не добавлен в заявку, то откроется окно добавления позиции с вводом количества и выбором упаковки. Назад возвращаться по кнопке < в верхней части экрана. Сохранить - по иконке V. 
...
Если считаете, что заявка (или заявки) готова к отправке, то это можно сделать несколькими способами:


- Из экрана **Заявка**

    - нажать на иконку дискетки  <img src="img/1.Connection/1.IconAutoTransl.jpg" alt="drawing" height="22"/> , чтобы перевести документ в статус **Готов к отправке**. Такой документ надо еще отправить, но можно позже. Этим способом можно воспользоваться при отсутствии интернета. 
...
После ввода необходимых данных, заявку отправляют на сервер, но, чтобы отправить документ на обработку, необходимо снять признак **Черновик**. Это можно сделать несколькими способами:
...
- справа - предыдущие - все заявки по магазину.

<img src="img/5.Routes/5.AllOrders.jpg" alt="drawing" height="400"/>

 Предыдущие можно просматривать и копировать в текущий визит.
 
  Для этого нужно выбрать заявку из данного списка и выбрать пункт из меню " **✚** " *"Копировать заявку"*. После чего произойдет переход на новую скопированную заявку, которую можно редактировать.
