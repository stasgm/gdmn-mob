...
|Использовать матрицы|_Если указан_, то при добавлении товаров в заявки цены будут вытягиваться из матриц по конкретным организациям. <br> _Если не указан_, то будут использоваться справочники ТМЦ. |
