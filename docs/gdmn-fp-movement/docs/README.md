...
[### Редактирование позиции
  По нажатию на позициию можно изменить:
| Тип | Описание |
| ------------ | -------- |]:#
...
Во всем остальном работа с документом **Отвес** и **Отвес $** в мобильном приложении идентична работе с документом **Перемещение**, описанным выше.
