...
| Параметр | Описание |
| ------------ | -------- |
|Запрашивать справочники|_Если указан_, то при при каждой синхронизации на сервер будет отправляться запрос за справочниками, который будет обрабатываться сервером и возвращаться в ответ с запрашиваемыми справочниками. <br> _Если не указан_, то запрос генерироваться не будет. Справочники будут выгружаться из сервера автоматически при каких-либо очередных изменениях на сервере|
...
Данная опция предназаначена для оформления отвес-накладных при отгрузке товаров в магазины фирменной торговли либо сторонним клиентам без предварительной заявки. В Гедымине будет создан документ "Реализация ГП".
...
Данная опция предназаначена для оформления отвес-накладных при отгрузке товаров в магазины фирменной торговли либо сторонним клиентам по предварительным заявкам. В Гедымине будет создан документ "Реализация ГП".
...
Данная опция предназаначена для оформления возврата товара от покупателей. В Гедымине будет создан документ "".
...
Данная опция предназаначена для оформления инвентаризации товаров на складе. В Гедымине будет создан документ "".
...
Данная опция предназаначена для оформления перемещения товаров в лабораторию. В Гедымине будет создан документ "".
...
На ТСД по нажатию на **F3**, отрисуется диалоговое окно, в котором можно ввести вес для последней добавленной позиции. При этом, количество коробок обнулится.
