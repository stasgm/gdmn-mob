...
Загрузка данных и работа в приложении пояснена далее в пунктах 3-7.
...
Сканирование товара на ТСД осуществляется нажатием кнопки сканирования на устройстве из экрана документа. Если товар по считанному штрихкоду будет найден в справочнике товаров, то будет создана новая позиция с данными из штрихкода.
