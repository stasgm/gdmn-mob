...
Также в окне "Настройка подключения" (в это окно ) есть кнопка "Сбросить настройки", по нажатию на которую вызовется диалоговое окно, где можно указать следующие действия:
...
|Нулевые остатки в склад. документах|   |
|Типы штрихкодов|                       |
...
От получения справочников можно отказаться - через установление параметра **"Запрашивать справочники"** в отрицательное положение, в Общих настройки в окне Настройки.
