...
|Готов к отправке| Зеленый |<img src="img/1.Connection/1.IconReadyToGo.jpg" alt="drawing" height="22"/>| Документ, который можно отправлять на обработку вручную или который, будет отправлен автоматически при включённой автосинхронизации (снят признак **Черновик**). Нельзя редактировать, но можно вернуть в состояние Черновик и отредактировать |
