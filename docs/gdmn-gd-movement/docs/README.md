...
При статусе **Готов к отправке** <img src="img/1.Connection/1.IconReadyToGo.jpg" alt="drawing" height="22"/> это можно сделать, только нажав на значок <img src="img/1.Connection/1.IconEdit.jpg" alt="drawing" height="22"/> **Редактирование документа** на шапке документа.
