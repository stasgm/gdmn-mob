...
- на вопрос "Уверены, что хотите удалить позиции документа?" нажать на кнопку **Отмена**, при этом все зеленые галочки останутья на месте, можно продолжить редактировать удаление позиций документа.
