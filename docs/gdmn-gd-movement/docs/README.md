...
- оставить документ в состоянии **Готов к отправке** с помощью иконки <img src="img/1.Connection/1.IconAutoTransl.jpg" alt="drawing" height="22"/> и перейти к работе с другими документами, а данный будет отправлен на сервер при ручной или автоматической синхронизации.
...
<img src="img/11.About/11.About.jpg" alt="drawing" height="400"/> 
