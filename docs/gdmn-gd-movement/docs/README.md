...
С помощью сканера в документах **Сканирование** можно считать **DataMatrix код**. С помощью сканера в документах **Приход**, **Инвентаризация** считываются линейные штрихкоды.
