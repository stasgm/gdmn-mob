...
При выходе из демо режиме, кнопка **Выйти из демо режима** меняется на **Сменить пользователя**. Также здесь можно выйти из учетной записи пользователя.
...
Вернемся на экран списка документов сканирования, выбрав пункт бокового меню **Сканирование**.

Чтобы найти документ по наименованию можно воспользоваться строкой поиска в правом верхнем углу экрана.

При создании документ имеет статус Черновик. Заполняем необходимые поля: Номер, Дата, Подразделение, Комментарий и сохраняем документ, нажав на иконку **✓**.
