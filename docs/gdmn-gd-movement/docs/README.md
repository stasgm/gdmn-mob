...
- нажав на иконку **×** , в левом верхнем углу, с выбранных позиций, отмеченных зелеными галочками, исчезнут все эти галочки.
- в появившемся окне "Уверены, что хотите удалить позиции документа?" выбрать кнопку **Отмена**, при этом все зеленые галочки останутся на месте, можно продолжить редактировать удаление позиций документа.
...
Для удаления нужно нажать на необходимый документ и удерживать его, после чего появится зеленая галочка, которая выделит данный документ среди прочих. Далее необходимо нажать иконку **Мусорная корзина** и подтвердить желание удалить документ. Документ удаляется. 

<img src="img/3.Docs/3.DelDoc.jpg" alt="drawing" height="400"/>

Удалить документ можно так же используя пункты меню **⁝** (если документ находиться в статусе **Черновик**).

<img src="img/3.Docs/3.3.MenuDelDoc.jpg" alt="drawing" height="400"/>

Используя иконку меню **⁝** , расположенную в правом верхнем углу, экрана **Документ** возможно: 
...
- нажав на иконку **×** , в левом верхнем углу, исчезнуть все зеленые галочки
- на вопрос "Уверены, что хотите удалить документы?" нажать на кнопку **Отмена**, при этом все зеленые галочки останутья на месте, можно продолжить редактировать удаление документов.
