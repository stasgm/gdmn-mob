...
* в документе необходимо вручную поменять признак **Черновик** на признак **Готов к отправке** с помощью значка <img src="img/1.Connection/1.IconEdit.jpg" alt="drawing" height="22"/> в шапке документа. 

* или нажать на значок <img src="img/1.Connection/1.IconSend.jpg" alt="drawing" height="22"/>, который автоматически переведёт признак с **Черновик** на **Готов к отправке** и отправит документ на обработку.
