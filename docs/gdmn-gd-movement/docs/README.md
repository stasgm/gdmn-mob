...
Нажимаем на иконку штрихкода <img src="img/10.Scanner/10.IconScanner.png" alt="drawing" height="30"/> в верхнем правом углу и переходим на экран сканирования товара.
