...
Цвет иконки или боковой полосы документа означает его статус. При смене статуса меняется и цвет.
...
По нажатию на иконку **+** в верхнем правом углу переходим на экран добавления документа. Обязательные поля для заполнения: **Номер**, **Дата**, **Тип** и поля в зависимости от типа документа.
...
Поля контактов ограничиваются типами, которые можно выбирать:
- Подразделение
- Организация
- Сотрудник
...
Переходим на экран просмотра документа. По нажатию на кнопку меню, расположенную в правом верхнем углу доступны следующие операции: **Добавить товар**, **Редактировать данные**, **Удалить заявку**.
...
- через сканирование по штрихкоду
